...
const axiosPut = async () => {
    try {
        ...
        const resp = await axios.put('http://localhost:8080/productos/vista/1'/*copiar ID segun producto de la DB*/, prod);
...
const axiosDelete = async () => {
    try {
        ...
        const resp = await axios.delete('http://localhost:8080/productos/vista/1');
